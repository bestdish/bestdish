/**
 * AI Scraper - Birmingham Batch (5 at a time)
 */
...
async function main() {
  console.log('🍽️  BestDish AI Scraper - Birmingham Batch')
  ...
  try {
    ...
    if (!birmingham) {
      console.error('❌ Birmingham not found')
      process.exit(1)
    }
    ...
    console.log(`📊 Found ${restaurants.length} Birmingham restaurants (batch of 5)`)
    console.log('')
