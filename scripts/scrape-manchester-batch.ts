/**
 * AI Scraper - Manchester Batch (5 at a time)
 */
...
async function main() {
  console.log('🍽️  BestDish AI Scraper - Manchester Batch')
  ...
  try {
    ...
    // Fetch Manchester restaurants without a best dish
    ...
    console.log(`📊 Found ${restaurants.length} Manchester restaurants (batch of 5)`)
    console.log('')
