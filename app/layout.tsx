        ...
        <footer className="bg-muted/30 border-t border-border mt-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                <h3 className="font-semibold text-foreground mb-3" style={{ fontFamily: 'var(--font-geist-sans), -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>Explore</h3>
              ...
              <div>
                <h3 className="font-semibold text-foreground mb-3" style={{ fontFamily: 'var(--font-geist-sans), -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>Company</h3>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <li><Link href="/admin" className="hover:text-primary" style={{ fontFamily: 'var(--font-geist-sans), -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>Admin</Link></li>
                </ul>
              </div>
              
              <div>
                <h3 className="font-semibold text-foreground mb-3" style={{ fontFamily: 'var(--font-geist-sans), -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>Legal</h3>
                <ul className="space-y-2 text-sm text-muted-foreground">
